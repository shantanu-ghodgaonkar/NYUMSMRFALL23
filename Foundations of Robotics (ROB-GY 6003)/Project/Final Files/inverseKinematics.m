function result = inverseKinematics(pose)
    ...
    %while not(result(1)<(pi/2)) | (result(1)>(3*pi/4)) & not(result(2)<(pi/2)) | (result(2)>(3*pi/4)) & not(result(3)<(pi/2)) | (result(3)>(3*pi/4)) & not(result(4)<(pi/2)) | (result(4)>(3*pi/4)) & not(result(5)<(pi/2)) | (result(5)>(3*pi/4)) & not(result(6)<(pi/2)) | (result(6)>(3*pi/4))
